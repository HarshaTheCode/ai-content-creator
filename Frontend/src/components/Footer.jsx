...
const Footer = () => {
    ...
    return (
        <footer className="bg-black text-white border-t border-white/10 pt-16 pl-25 pb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-400 text-sm leading-relaxed">
                            Crafting professional resumes with the power of artificial intelligence. Stand out from the crowd and land your dream job.
                        </p>
                    </div>
